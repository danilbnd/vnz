...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getAnswers: function getAnswers() {
      ...
      var a = this.userAnswers.filter(function (x) {
        return x === "a";
      }).length;
      var b = this.userAnswers.filter(function (x) {
        return x === "b";
      }).length;
  ...
  mounted: function mounted() {
    ...
    fetch("assets/json/mydoc.json").then(function (res) {
      return res.json();
    }).then(function (list) {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./src/assets/js/components/Result.vue?vue&type=script&lang=js&":
/*!****************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--0!./node_modules/vue-loader/lib??vue-loader-options!./src/assets/js/components/Result.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      answerA: Math.round(window.localStorage.getItem("answerA") / 12 * 100),
      answerB: Math.round(window.localStorage.getItem("answerB") / 12 * 100)
    };
  }
});
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass: "ba-form",
      attrs: { action: "result-test.html", method: " post", id: "testform" },
      on: { submit: _vm.getAnswers }
    },
    [
      _vm._l(_vm.questions, function(item, index) {
        return _c("fieldset", [
          _c("legend", [_vm._v(_vm._s(item.question))]),
          _vm._v(" "),
          _c("label", { attrs: { for: "a" + index } }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.userAnswers[index],
                  expression: "userAnswers[index]"
                }
              ],
              staticClass: "answer",
              attrs: {
              ...
              domProps: { checked: _vm._q(_vm.userAnswers[index], "a") },
              on: {
                change: function($event) {
                  return _vm.$set(_vm.userAnswers, index, "a")
                }
              }
            }),
            _vm._v("\n        " + _vm._s(item.answerA) + "\n      ")
          ...
          _c("label", { attrs: { for: "b" + index } }, [
            _c("input", {
              ...
              domProps: { checked: _vm._q(_vm.userAnswers[index], "b") },
              on: {
                change: function($event) {
                  return _vm.$set(_vm.userAnswers, index, "b")
                }
              }
            }),
            _vm._v("\n        " + _vm._s(item.answerB) + "\n      ")
      ...
      _c(
        "button",
        { staticClass: "ba-button ba-button--test", attrs: { id: "btn" } },
        [_vm._v("перевірити тест")]
      )
    ],
    2
  )
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./src/assets/js/components/Result.vue?vue&type=template&id=6f61ac5a&":
/*!**********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/assets/js/components/Result.vue?vue&type=template&id=6f61ac5a& ***!
  \**********************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    _c(
      "div",
      { staticClass: "column ba-box ba-box--math small-12 medium-8 large-5" },
      [
        _c("div", { staticClass: "row" }, [
          _c("img", {
            staticClass: "column small-6 medium-4 large-5",
            attrs: { src: "assets/img/mozgi1.png", alt: "mozgi" }
          }),
          _vm._v(" "),
          _c(
            "div",
            { staticClass: "column ba-box__text small-6 medium-4 large-6" },
            [
              _c("span", [_vm._v(_vm._s(_vm.answerA) + "%")]),
              _vm._v(" "),
              _c("p", [_vm._v("Математичний склад розуму")])
            ]
          )
        ])
      ]
    ...
    _c(
      "div",
      { staticClass: "column ba-box ba-box--hug small-12 medium-8 large-5" },
      [
        _c("div", { staticClass: "row" }, [
          _c("img", {
            staticClass: "column small-6 medium-4 large-5",
            attrs: { src: "assets/img/mozgi2.png", alt: "mozgi" }
          }),
          _vm._v(" "),
          _c(
            "div",
            { staticClass: "column ba-box__text small-6 medium-4 large-6" },
            [
              _c("span", [_vm._v(_vm._s(_vm.answerB) + "%")]),
              _vm._v(" "),
              _c("p", [_vm._v("Гуманітарний склад розуму")])
            ]
          )
        ])
      ]
...
/* harmony import */ var _main__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./main */ "./src/assets/js/main.js");
...
var sliderChoise = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ba-slider-choise');
sliderChoise.slick({
  rows: 2,
  slidesPerRow: 2,
  dots: true,
...
var sliderSpec = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ba-slider-spec');
sliderSpec.slick({
  rows: 2,
  slidesPerRow: 2,
  dots: true,
...
/***/ "./src/assets/js/components/Result.vue":
/*!*********************************************!*\
  !*** ./src/assets/js/components/Result.vue ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Result_vue_vue_type_template_id_6f61ac5a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Result.vue?vue&type=template&id=6f61ac5a& */ "./src/assets/js/components/Result.vue?vue&type=template&id=6f61ac5a&");
/* harmony import */ var _Result_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Result.vue?vue&type=script&lang=js& */ "./src/assets/js/components/Result.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Result_vue_vue_type_template_id_6f61ac5a___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Result_vue_vue_type_template_id_6f61ac5a___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "src/assets/js/components/Result.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./src/assets/js/components/Result.vue?vue&type=script&lang=js&":
/*!**********************************************************************!*\
  !*** ./src/assets/js/components/Result.vue?vue&type=script&lang=js& ***!
  \**********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Result_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--0!../../../../node_modules/vue-loader/lib??vue-loader-options!./Result.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./src/assets/js/components/Result.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Result_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./src/assets/js/components/Result.vue?vue&type=template&id=6f61ac5a&":
/*!****************************************************************************!*\
  !*** ./src/assets/js/components/Result.vue?vue&type=template&id=6f61ac5a& ***!
  \****************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Result_vue_vue_type_template_id_6f61ac5a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./Result.vue?vue&type=template&id=6f61ac5a& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./src/assets/js/components/Result.vue?vue&type=template&id=6f61ac5a&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Result_vue_vue_type_template_id_6f61ac5a___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Result_vue_vue_type_template_id_6f61ac5a___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
/* harmony import */ var _components_Result_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/Result.vue */ "./src/assets/js/components/Result.vue");
...
new Vue({
  ...
  template: '<Result/>',
  components: {
    Result: _components_Result_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  }
});
